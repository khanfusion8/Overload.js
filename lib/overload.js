...
(function() {
  ...
  function isMatch(obj1, obj2) {
    ...
    if ((typeof obj1 === 'undefined' && obj1 === obj2) || ((typeof obj1).match(/boolean|function|string|number/) && obj1.constructor === obj2) || (typeof obj2 === 'function' && obj1 instanceof obj2 && obj2 !== Object) || (typeof obj1 === 'object' && ((obj1 === null && obj1 === obj2) || (obj1 !== null && obj1.constructor === obj2)))) {
      return true;
    }
  ...
  window.overload = {
     ...
     */
      ...
      return {
        oType_except: [].slice.call(arguments)
      };
    },
    ...
    match: function() {
      return {
        oType_match: [].slice.call(arguments)
      };
    },
    ...
    def: function() {
      ...
      if (typeof method === 'function' || args.length > 0) {
        ...
        temp.unshift(function() {
          if ((match && any && arguments.length < len) || (!match && any && arguments.length < len) || (match && !any && arguments.length !== len)) {
            return;
          }
